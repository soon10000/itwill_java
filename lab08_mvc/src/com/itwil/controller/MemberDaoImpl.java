...
public class MemberDaoImpl implements MemberDao {
	...
	private int count = 0; // 배열에 원소가 추가될 때 마다 ++
	...
	public Member read(int index) {
		// 인덱스 범위 밖의 숫자를 입력하는 경우 "올바른 숫자를 입력하세요" 라고 리턴이 될 수 있도록
	...
	/**
	 * 인덱스가 배열의 유효한 인덱스인 지를 검색 인덱스가 0 이상이고, 배열에 저장된 원소 개수보다 작으면 true, 그렇지 않으면 false를
	 * 리턴
	 * 
