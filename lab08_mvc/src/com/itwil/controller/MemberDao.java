...
public interface MemberDao {
	 ...
	 * @return 배열에 회원 정보를 저장 성공하면 1, 실패하면 0
	 */
	int create(Member member);
	
	/**
	 * 회원 전체 목록 검색. 회원 정보가 저장된 배열을 리턴.
	 * @return 회원 정보를 저장하고 있는 (Member[])
	 */
	Member[] read();
	 ...
	 * @return 아규먼트 index가 회원 배열이 인덱스 범위 안에 있으면, Member 타입 객체를 리턴
	...
	/**
	 * 회원 정보 업데이 기능. 회원 배열의 특정 인덱스에 있는 회원 정보 중에서 비밀번호를 변경
