...
public class InheritanceMain03 {
	...
	public static void main(String[] args) {
		...
		//다형성(polymorphusm)을 사용한 변수 선언과 초기화
...
//		HybridCar car = new Car(100, 100); -> 문법의 순서가 맞지 않음 Car is HybridCar는 맞지 않음
	...
	public static void test(Car car) {
		...
		// 변수 instanceof Type(Class): 변수가 클래스 타입아면 true, 그렇지 않으면 false.
