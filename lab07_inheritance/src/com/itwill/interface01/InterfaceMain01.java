...
/*
 * 인터페이스(interface):
 * 사용 목적: 팀/회사 간 분업/협업 하기 위해서 메서드들의 signature를 약속하는 특별한 클래스
 * 인터페이스가 가질 수 있는 맴버:
 *   (1) public static final 필드 - public static final 수식어는 생략 가능.(거의 대부분 생략해서 작성) - 상수
 *   (2) public abstract 메서드 - public abstract 생략 가능 - 추상메서드
 *   
 ...
 * 인터페이스는 상위 인터페이스를 상속(확장)할 수 있음. 인터페이스는 다중상속이 가능
...
public class InterfaceMain01 {
	...
	public static void main(String[] args) {
		// OracleDatebase 객체를 생성하고, 메서드들을 이용
