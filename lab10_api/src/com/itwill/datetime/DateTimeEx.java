...
public class DateTimeEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(today);  // toString 메소드가 override가 되어 있어서 날짜로 보여짐
		...
		LocalDate birthday = LocalDate.of(1991, 8, 5);
		...
		LocalDateTime time = LocalDateTime.of(2024, 3, 14, 9, 30, 51);
		System.out.println(time);
		
		// Timestamp: 1970-01-01 00:00:00를 기준으로 해서 1/1000초(milli-second)마다
		// 정수를 1씩 증가하는 정수(long 타입)를 기반으로 날짜와 시간 정보를 저장하는 클래스(타입)
