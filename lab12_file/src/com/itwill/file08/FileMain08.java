 ...
 *    이클립스에서 자바 프로그램을 실행(Run as Java application)할 때, 현재작업 폴더의 위치는 프로젝트 폴더.
 * 절대 경로(absolute path):
 ...
 *     o. Linux, MaxOS 파일 경로: "/users/itwill/documents"
 */
...
public class FileMain08 {
	...
	public static void main(String[] args) {
		...
		// File 클래스: 
		// 파일(txt, jpg, mp4m ...)과 폴더(디렉토리)에 관련된 기능들을 가지고 있는 클래스
