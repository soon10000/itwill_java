...
public class ArrayMain01 {
	...
	public static void main(String[] args) {
		...
		//    ㄴ 배열에서 데이터가 저장된 위치를 나타내는 정수.
		//    ㄴ 인덱스는 0부터 시작하는 연속된 정수●
		//    ㄴ 배열의 마지막 인덱스는 (배열의 원소 개수 - 1).
		
		// 배열 선언 & 초기화 방법 1:
		// 타입[] 변수이름 = new 타입[원소 개수];
		//     ㄴ 배열의 모든 원소를 그 타입의 기본값으로 초기화를 해줌.
		//     ㄴ 정수 타입 기본값(0), 실수 타입 기본값(0.0), boolean 타입의 기본값(false)
		//     ㄴ 그 이외의 타입들의 기본값(null)
		...
		// length : 배열의 길이 즉, 배열의 원소 개수 
		// length의 경우 배열의 원소 개수의 타입이기 때문에 정수의 타입이다.
		System.out.println("lenth = " + scores.length);
