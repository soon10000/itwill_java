...
public class ClassMain02 {
	...
	public static void main(String[] args) {
		...
		System.out.println("java = " + score1.java); // 필드에서 데이터를 가지고 올 때 "." 사용
		
		// socore1 인스턴스의 필드 값 변경:
		score1.java = 100;
		score1.sql = 90;
		score1.javascript = 85;
		
		
		//score1 인스턴스의 메서드를 호출:
		...
		System.out.println("scroe2 총점 : " + score2.getTotal());
		System.out.println("scroe2 총점 : " + score2.getMean());
