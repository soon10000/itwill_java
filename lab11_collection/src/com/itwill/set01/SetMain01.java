...
public class SetMain01 {
	...
	public static void main(String[] args) {
		...
		// 향상된 for 문장은 가능. for(int i = 0 ; i < size ; i++) {} 형식의 반복문은 사용할 수 없음! 인덱스가 없기 때문이다.
		for (Integer x : numbers) {
			System.out.print(x + ", ");
		}
		System.out.println();
		
		// Set<E>.set(int index, E value) 메서드를 제공하지 않음. 인덱스가 없기 때문이다.
		// Set<E>.remove(int index) 메서드를 제공하지 않음. 인덱스가 없기 때문
