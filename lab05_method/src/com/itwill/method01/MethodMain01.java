...
/*
 * 메서드(method): class 안에서 작성하는 함수(funtion)/기능
 * - 프로그램에서 반복적으로 사용되는 기능들을 코드 블록으로 작성.
 * - 기능이 필요한 곳에서 불러서(호출해서) 사용하기 위한 코드
 * - 자바 언어는 class 안에서만 함수를 작성할 수 있음 -> 자바는 메서드만 작성할 수 있음.
 * 
...
public class MethodMain01 {
	...
	// mian 메서드(method) " 프로그램의 시작과 끝
	public static void main(String[] args) {
		
		System.out.println("안녕하세요.");
		//-> println 메소드를 호출.
		//-> println을 호출할 때 전달한 값("안녕하세요.")을 agument라고 함
		//-> println 메서드에서 아규먼트를 저장하기 위해서 선언한 변수 -> parameter 라고 함
		//-> println은 반환값이 없는 메서드 
		
		Random rand = new Random();
		
		int x = rand.nextInt(10);
		//-> nexInt 메서드를 호출. 아규먼트 10을 전달
